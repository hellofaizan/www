...
Here's a [link to somewhere](https://example.com) and a link with an image: [![Alt text](/path/to/image.jpg)](https://example.com).
...
```tsx {4, 5} showLineNumbers title="HelloWorld" /async/
...
![Alt text for image](/path/to/demo-image.jpg)
